...
- (void)buildLinuxMenu {
    ...
    // Note: We don't set a main menu on GNUstep to avoid creating an unwanted visible menu window
    // Keyboard shortcuts work through the button key equivalents in the floating panel
